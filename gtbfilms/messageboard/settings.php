...
$settings['apass']='danog';

// Website title
$settings['website_title']="<H1>GtBFilms Ideas Scratchpad</H1>";

// Website URL
$settings['website_url']='http://www.gonadovision.homeip.net/video';

// Message board title
$settings['mboard_title']="GtBFilms Idea Scratchpad";

// URL to folder where message board is installed
// DO NOT a trailing "/" !
$settings['mboard_url']='http://www.gonadovision.homeip.net/video/messageboard';
