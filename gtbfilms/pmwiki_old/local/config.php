...
#Setup mailform function
include_once('cookbook/mailform.php');
$MailFormAddresses['Pm'] = 'enquiry@gtbfilms.co.uk';
$MailFormDefaultSender = 'default@anon.com';
...
# Add anti-swearing blocker
#if ($action=='edit') include_once('cookbook/blocklist2.php');
#$EnableWhyBlocked = "1"

##  $ScriptUrl is your preferred URL for accessing wiki pages
##  $PubDirUrl is the URL for the pub directory.
#$ScriptUrl = 'http://www.gtbfilms.co.uk/pmwiki/pmwiki.php';
#$PubDirUrl = 'http://www.gtbfilms.co.uk/pmwiki/pub';
...
$DefaultPasswords['admin'] = crypt('danog');
#$DefaultPasswords['edit'] = crypt('attic');
#$DefaultPasswords['read'] = crypt('attic');
    ## Define usernames and passwords.
    $AuthUser['gonad'] = crypt('danog');
    $AuthUser['baldas'] = crypt('sadlab');
    $AuthUser['splodge'] = crypt('egdolps');
    $AuthUser['magnox'] = crypt('xongam');
    $AuthUser['jane'] = crypt('enaj');
...
##Ok lets set the author automatically to who they signed in as:
...
# Following edited out due to being redundant - named user access only
# $DefaultPasswords['upload'] = crypt('attic');
...
## Fortune Cookies
$FortunesDir = "cookbook/fortune/";
include_once("cookbook/fortune.php");
