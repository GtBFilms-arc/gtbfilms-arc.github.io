...
XLSDV('en', array(
  'MF' => '',
  'MFsuccess' => '%green%Message has been sent successfully.',
  'MFfailure' => '%red%Message could not be sent',
  'MFerror' => '%red%An error has occurred.'));
...
SDV($MailFormFmt,"<form action='\$PageUrl'>
