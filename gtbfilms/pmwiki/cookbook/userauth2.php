...
/*
  UserAuth2 (Version 2.1-beta3) - A user-based authorization and authentication module.
...
define(USERAUTH_VERSION, '2.1');  // compatibility
define(USER_AUTH_VERSION, '2.1'); // compatibility
define(USERAUTH2_VERSION, '2.1');

$RecipeInfo['UserAuth2']['Version'] = '2008-01-08';
